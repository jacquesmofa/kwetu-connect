...
const ProgramsPage = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* SEO Metadata */}
      <title>Programs & Services | KWETU CONNECT | Cultural Resilience & Community Wellbeing</title>
      <meta name="description" content="Explore KWETU CONNECT's comprehensive programs: Mental Health & Wellbeing, Cultural Exchange, Community Chaplaincy, Job Opportunities, Seniors Wisdom, and community empowerment initiatives in Australia." />
      <meta name="keywords" content="cultural resilience programs, community wellbeing Australia, mental health programs Sydney, cultural exchange programs, caregiver support Australia, seniors wisdom program" />
      <link rel="canonical" href="https://kwetuconnect.com.au/programs" />
      <meta property="og:title" content="Programs & Services | KWETU CONNECT | Cultural Resilience Australia" />
      <meta property="og:description" content="Comprehensive programs for cultural resilience, mental health, community chaplaincy, job opportunities, and seniors wisdom across Australia." />
      <meta property="og:url" content="https://kwetuconnect.com.au/programs" />
